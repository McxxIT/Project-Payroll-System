        ...
        <div class="sidebar-wrapper">
            <div class="sidebar-flex">
                ...
                <div class="sider-menu">
                    ...
                    <a class="menu-background active"><i class="bi bi-person-rolodex"></i><span>Applicant</span></a>
                            ...
                            <div class="table-body-1">
                                ...
                                <div class="table-row-1">
                                    ...
                                    <div class="applicant-cell">
                                        <form action="/applicant/accepted/{{ $userApplicant->id }}" method="post">
                                            @csrf
                                            <button type="submit" class="button accept">Accept</button>
                                        </form>
                                        <form action="/applicant/declined/{{ $userApplicant->id }}" method="post">
                                            @csrf
                                            <button type="submit" class="button decline">Decline</button>
                                        </form>
                                    </div>
                                    <div class="applicant-cell">{{ $userApplicant->created_at->toDateString() }}</div>
                                </div>
                                @endforeach
